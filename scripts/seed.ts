/**
 * Seed script — Milestones 1 and 2.
 *
 *   npm run seed
 *
 * Creates the Owner account, the known price catalog, and the backdrop
 * packages, so the app is demo-ready on first run (Spec 5). With
 * SEED_DEMO_USERS=true it also adds one account per role plus sample
